  ...
  return (
    <aside
      ...
      style={{
        ...
        borderTop: "1px solid rgba(184, 147, 90, 0.32)",
    ...
    >
      ...
      <a
        ...
        style={{
          ...
          height: 52,
          borderRadius: 999,
          background: "linear-gradient(180deg, #c9a570 0%, #b8935a 50%, #9a7847 100%)",
          color: "#fdfbf6",
          display: "inline-flex",
          alignItems: "center",
          justifyContent: "center",
          ...
          textDecoration: "none",
          boxShadow:
            "0 0 0 1px rgba(154, 120, 71, 0.6), 0 1px 0 rgba(255, 240, 210, 0.4) inset",
